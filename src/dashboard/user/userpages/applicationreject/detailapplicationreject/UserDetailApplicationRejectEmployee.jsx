...
const UserDetailApplicationRejectEmployee = () => {
                  ...
                  <MDBCol md="12">
                    <MDBCardBody className="p-4">
                      ...
                      <MDBRow className="pt-1">
                        ...
                        <NavLink className="btn btn-secondary my-5 text-center text-white text-decoration-none" to="/user/list-user-application-reject-employee">Back</NavLink>
                    </MDBCardBody>
                  </MDBCol>
                </MDBRow>
              </MDBCard>
...
export default UserDetailApplicationRejectEmployee;
