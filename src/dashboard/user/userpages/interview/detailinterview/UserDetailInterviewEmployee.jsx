...
const UserDetailInterviewEmployee = () => {
  const { id } = useParams();
  console.log(id);
                    ...
                    <MDBCardBody className="p-4">
                      ...
                      <MDBRow className="pt-1">
                        ...
                        <MDBCol size="12" className="mb-3">
                          ...
                          <MDBCardText className="text-muted">
                          <div className="mt-3" dangerouslySetInnerHTML={{ __html: detailinterview.applications?.jobPostings.jobDescription.split("").slice(0,10000).join("") }}></div>
                          </MDBCardText>
                        </MDBCol>
                        <MDBCol size="12" className="mb-3">
                          <MDBTypography tag="h6">Job Requirements</MDBTypography>
                          <MDBCardText className="text-muted">
                          <div className="mt-3" dangerouslySetInnerHTML={{ __html: detailinterview.applications?.jobPostings.requirements.split("").slice(0,10000).join("") }}></div>
                          </MDBCardText>
                        </MDBCol>
                      </MDBRow>

                      <MDBTypography tag="h6">Applicant Information</MDBTypography>
                      <hr className="mt-0 mb-4" />
                      <MDBRow className="pt-1">
                        <MDBCol size="6" className="mb-3">
                        ...
                        <MDBCol size="6" className="mb-3">
                          ...
                          {/* <div className="card-text" dangerouslySetInnerHTML={{ __html: detailinterview.jobPostings?.jobDescription.split("").slice(0,40).join("") }} /> */}
                          </MDBCardText>
                        </MDBCol>
                        <MDBCol size="6" className="mb-3">
...
export default UserDetailInterviewEmployee;
