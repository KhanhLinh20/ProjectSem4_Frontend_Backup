...
const UserDetailApplicationJobPostingEmployee = () => {
  ...
  const fetchdata = async () => {
    const res = await axiosclient.get(
      `/shopee-career/get-applicationbyid/${id}`
    );
...
//     });
//     console.log("id application ID:",applicationID);
//     if (result.isConfirmed) {
//       setIsLoading(true);
//       try {
//         const res = await axiosclient.post(
//           `/shopee-career/application-change-status-fail-by employer/${applicationID}`
//         );
     
//         Swal.fire(
//           "Success",
//           "The application has been marked as Fail.",
//           "success"
//         ).then(() => {
//           navigate("/user/list-user-application-employee-withow-interview"); // Điều hướng đến trang danh sách từ chối
//         });
//       } catch (error) {
                    ...
                    <MDBCardBody className="p-4">
                      ...
                      <MDBRow className="pt-1">
                        <MDBCol size="6" className="mb-3">
                          ...
                          <MDBCardText className="text-muted">
                            {moment(detailapplication.createdAt).format(
                              "DD/MM/YYYY"
                            )}
                          </MDBCardText>
                        </MDBCol>
                      ...
                      <MDBRow className="pt-1">
                        ...
                        <MDBCol size="6" className="mb-3">
                          ...
                          <MDBCardText className="text-muted">
                            {
                              detailapplication.jobPostings?.jobCategory
                                ?.categoryName
                            }
                          </MDBCardText>
                        </MDBCol>
                          ...
                          <MDBCardText className="text-muted">
                            <div
                              ...
                              dangerouslySetInnerHTML={{
                                __html:
                                  detailapplication.jobPostings?.jobDescription
                                    ?.split("")
                                    .slice(0, 5000)
                                    .join(""),
                              }}
                        ...
                        <MDBCol size="12" className="mb-3">
                          ...
                          <MDBCardText className="border p-3 rounded bg-light">
                            <div
                              ...
                              dangerouslySetInnerHTML={{
                                __html:
                                  detailapplication.jobPostings?.requirements
                                    ?.split("")
                                    .slice(0, 5000)
                                    .join(""),
                              }}
                      ...
                      {/* <div className="d-flex justify-content-center my-5">
                        <button
                          className="btn btn-danger text-white text-decoration-none me-3"
                          onClick={() =>
                            updatechangestatusreject(
                        ...
                        <NavLink
                          ...
                          to={`/user/user-create-interview-employee/${detailapplication.applicationID}`}
                        >
                          Set up an Interview
                        </NavLink>
                      </div> */}
...
export default UserDetailApplicationJobPostingEmployee;
