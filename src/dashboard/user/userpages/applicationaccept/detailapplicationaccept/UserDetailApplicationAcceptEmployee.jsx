...
const UserDetailApplicationAcceptEmployee = () => {
                ...
                <MDBRow className="g-0" >
                  <MDBCol md="12">
                    <MDBCardBody className="p-4">
                      ...
                      <NavLink className="btn btn-secondary my-5 text-center text-white text-decoration-none" to="/user/list-user-application-accept-employee">
                        Back
                      </NavLink>
                    </MDBCardBody>
                  </MDBCol>
...
export default UserDetailApplicationAcceptEmployee;
