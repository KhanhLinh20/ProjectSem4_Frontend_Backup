...
const DetailInterviewApplicationAccept = () => {
                ...
                <MDBRow className="g-0" >
                  <MDBCol md="12">
                    <MDBCardBody className="p-4">
                      ...
                      <NavLink className="btn btn-secondary my-5 text-center text-white text-decoration-none" to="/admin/list-application-accept">
                        Back
                      </NavLink>
                    </MDBCardBody>
                  </MDBCol>
...
export default DetailInterviewApplicationAccept;
